...
def mainRun(kw_list):
    ...
    title_xpath = "//*[@class='sw-Card Ad']//h3[contains(concat(' ',normalize-space(@class),' '),'sw-Card__titleMain')]"
    #url and description
    url_xpath = "//*[@class='sw-Card Ad']//a[contains(concat(' ',normalize-space(@class),' '),'sw-Card__space')]"
    des_xpath = "//*[@class='sw-Card Ad']//*[@class='sw-Card__summary']"
    #page number and next page button
    page_xpath = "//*[@class='Pagenation__current']"
